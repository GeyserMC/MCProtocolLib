...
public class BaseTypesTest {
    ...
    public void readVarInt() {
        assertEquals(0x80808080, MinecraftTypes.readVarInt(Unpooled.wrappedBuffer(new byte[]{
    ...
    public void readVarIntTooLong() {
        try {
            ...
            MinecraftTypes.readVarInt(Unpooled.wrappedBuffer(new byte[]{
    ...
    public void readVarLong() {
        assertEquals(0x8080808080808080L, MinecraftTypes.readVarLong(Unpooled.wrappedBuffer(new byte[]{
    ...
    public void readVarLongTooLong() {
        try {
            ...
            MinecraftTypes.readVarLong(Unpooled.wrappedBuffer(new byte[]{
