...
/**
 * A {@link ByteBuf} that delegates all calls to another {@link ByteBuf}.
 * Fork of io.netty.buffer.WrappedByteBuf because it is package-private.
 */
public class DelegatedByteBuf extends ByteBuf {
    private final ByteBuf buf;

    protected DelegatedByteBuf(ByteBuf buf) {
