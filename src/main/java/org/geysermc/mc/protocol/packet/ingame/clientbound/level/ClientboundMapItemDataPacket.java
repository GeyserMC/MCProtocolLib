...
import org.geysermc.mc.protocol.data.game.level.map.MapData;
import org.geysermc.mc.protocol.data.game.level.map.MapIcon;
import org.geysermc.mc.protocol.data.game.level.map.MapIconType;
