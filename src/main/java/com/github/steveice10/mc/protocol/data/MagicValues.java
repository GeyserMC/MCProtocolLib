...
public class MagicValues {
    ...
    static {
        ...
        register(EntityType.PILLAGER, 61);
        register(EntityType.POLAR_BEAR, 62);
        register(EntityType.PRIMED_TNT, 63);
        register(EntityType.PUFFERFISH, 64);
        register(EntityType.RABBIT, 65);
        register(EntityType.RAVAGER, 66);
        register(EntityType.SALMON, 67);
        register(EntityType.SHEEP, 68);
        register(EntityType.SHULKER, 69);
        register(EntityType.SHULKER_BULLET, 70);
        register(EntityType.SILVERFISH, 71);
        register(EntityType.SKELETON, 72);
        register(EntityType.SKELETON_HORSE, 73);
        register(EntityType.SLIME, 74);
        register(EntityType.SMALL_FIREBALL, 75);
        register(EntityType.SNOW_GOLEM, 76);
        register(EntityType.SNOWBALL, 77);
        register(EntityType.SPECTRAL_ARROW, 78);
        register(EntityType.SPIDER, 79);
        register(EntityType.SQUID, 80);
        register(EntityType.STRAY, 81);
        register(EntityType.STRIDER, 82);
        register(EntityType.THROWN_EGG, 83);
        register(EntityType.THROWN_ENDERPEARL, 84);
        register(EntityType.THROWN_EXP_BOTTLE, 85);
        register(EntityType.THROWN_POTION, 86);
        register(EntityType.TRIDENT, 87);
        register(EntityType.TRADER_LLAMA, 88);
        register(EntityType.TROPICAL_FISH, 89);
        register(EntityType.TURTLE, 90);
        register(EntityType.VEX, 91);
        register(EntityType.VILLAGER, 92);
        register(EntityType.VINDICATOR, 93);
        register(EntityType.WANDERING_TRADER, 94);
        register(EntityType.WITCH, 95);
        register(EntityType.WITHER, 96);
        register(EntityType.WITHER_SKELETON, 97);
        register(EntityType.WITHER_SKULL, 98);
        register(EntityType.WOLF, 99);
        register(EntityType.ZOGLIN, 100);
        register(EntityType.ZOMBIE, 101);
        register(EntityType.ZOMBIE_HORSE, 102);
        register(EntityType.ZOMBIE_VILLAGER, 103);
        register(EntityType.ZOMBIFIED_PIGLIN, 104);
