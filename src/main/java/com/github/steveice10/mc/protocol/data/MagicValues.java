...
public class MagicValues {
    ...
    static {
        ...
        register(ParticleType.SNEEZE, 38);
        register(ParticleType.SPIT, 39);
        register(ParticleType.SQUID_INK, 40);
        register(ParticleType.SWEEP_ATTACK, 41);
        register(ParticleType.TOTEM_OF_UNDYING, 42);
        register(ParticleType.UNDERWATER, 43);
        register(ParticleType.SPLASH, 44);
        register(ParticleType.WITCH, 45);
        register(ParticleType.BUBBLE_POP, 46);
        register(ParticleType.CURRENT_DOWN, 47);
        register(ParticleType.BUBBLE_COLUMN_UP, 48);
        register(ParticleType.NAUTILUS, 49);
        register(ParticleType.DOLPHIN, 50);
        register(ParticleType.CAMPFIRE_COSY_SMOKE, 51);
        register(ParticleType.CAMPFIRE_SIGNAL_SMOKE, 52);
