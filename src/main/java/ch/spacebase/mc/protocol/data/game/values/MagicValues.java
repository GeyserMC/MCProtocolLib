...
import ch.spacebase.mc.protocol.data.game.values.entity.GlobalEntityType;
...
import ch.spacebase.mc.protocol.data.game.values.entity.player.Animation;
import ch.spacebase.mc.protocol.data.game.values.entity.player.BlockBreakStage;
import ch.spacebase.mc.protocol.data.game.values.entity.player.CombatState;
import ch.spacebase.mc.protocol.data.game.values.entity.player.GameMode;
import ch.spacebase.mc.protocol.data.game.values.entity.player.InteractAction;
...
import ch.spacebase.mc.protocol.data.game.values.statistic.GenericStatistic;
import ch.spacebase.mc.protocol.data.game.values.window.ClickItemParam;
import ch.spacebase.mc.protocol.data.game.values.window.CreativeGrabParam;
import ch.spacebase.mc.protocol.data.game.values.window.DropItemParam;
import ch.spacebase.mc.protocol.data.game.values.window.FillStackParam;
import ch.spacebase.mc.protocol.data.game.values.window.MoveToHotbarParam;
import ch.spacebase.mc.protocol.data.game.values.window.ShiftClickItemParam;
import ch.spacebase.mc.protocol.data.game.values.window.SpreadItemParam;
import ch.spacebase.mc.protocol.data.game.values.window.WindowAction;
...
import ch.spacebase.mc.protocol.data.game.values.world.GenericSound;
...
import ch.spacebase.mc.protocol.data.game.values.world.block.value.ChestValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.GenericBlockValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.MobSpawnerValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.NoteBlockValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.PistonValue;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.PistonValueType;
...
import ch.spacebase.mc.protocol.data.game.values.world.particle.GenericParticle;
