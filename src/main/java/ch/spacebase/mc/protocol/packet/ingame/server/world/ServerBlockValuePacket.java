...
import ch.spacebase.mc.protocol.data.game.values.world.block.value.BlockValue;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.BlockValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.ChestValue;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.ChestValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.GenericBlockValue;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.GenericBlockValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.MobSpawnerValue;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.MobSpawnerValueType;
import ch.spacebase.mc.protocol.data.game.values.world.block.value.NoteBlockValue;
