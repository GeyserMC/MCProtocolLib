...
import ch.spacebase.mc.protocol.data.game.values.statistic.BreakBlockStatistic;
import ch.spacebase.mc.protocol.data.game.values.statistic.BreakItemStatistic;
import ch.spacebase.mc.protocol.data.game.values.statistic.CraftItemStatistic;
import ch.spacebase.mc.protocol.data.game.values.statistic.GenericStatistic;
import ch.spacebase.mc.protocol.data.game.values.statistic.Statistic;
import ch.spacebase.mc.protocol.data.game.values.statistic.UseItemStatistic;
